...
public class ControllerCierrePeriodoCxc extends SelectorComposer<Component> {
    ...
    private static final Logger LOGGER = Logger.getLogger(ControllerCierrePeriodoCxc.class);
    ...
    public void VerificarTransacciones() throws SQLException {
        ...
        objAccesos = objDaoAccesos.Verifica_Permisos_Transacciones(20202000, usuario, empresa, sucursal);
                    ...
                    Messagebox.QUESTION, new EventListener() {
                        ...
                        public void onEvent(Event event) throws Exception {
                            if (((Integer) event.getData()).intValue() == Messagebox.OK) {
                                ...
                                objParamSalida = objDaoCierrePeriodo.CerrarPeriodoCxc(objCierrePeriodos);
                    ...
                    Messagebox.QUESTION, new EventListener() {
                        ...
                        public void onEvent(Event event) throws Exception {
                            if (((Integer) event.getData()).intValue() == Messagebox.OK) {
                                ParametrosSalida objParamSalida;
                                objCierrePeriodos.setCieper_usumod(objUsuCredential.getCuenta());
                                objParamSalida = objDaoCierrePeriodo.AbriPeriodoCxc(objCierrePeriodos);
                                if (objParamSalida.getFlagIndicador() == 0) {
                                    objlstCierrePeriodos.clear();
                                    seleccionaAnio();
                                }
