...
public class ControllerCierreDia extends SelectorComposer<Component> {
    ...
    private static final Logger LOGGER = Logger.getLogger(ControllerCierreDia.class);

    //Eventos Primarios - Transaccionales
    @Listen("onCreate=#tabbox_cierriadia")
    ...
    public void VerificarTransacciones() throws SQLException {
        ...
        objAccesos = objDaoAccesos.Verifica_Permisos_Transacciones(40301000, usuario, empresa, sucursal);
                    ...
                    Messagebox.QUESTION, new EventListener() {
                        ...
                        public void onEvent(Event event) throws Exception {
                            if (((Integer) event.getData()).intValue() == Messagebox.OK) {
                                ...
                                objParamSalida = objDaoCierreDia.CerrarDiaFacturacion(objCierreDias);
                    ...
                    Messagebox.QUESTION, new EventListener() {
                        ...
                        public void onEvent(Event event) throws Exception {
                            if (((Integer) event.getData()).intValue() == Messagebox.OK) {
                                ParametrosSalida objParamSalida;
                                objCierreDias.setCiedia_usumod(objUsuCredential.getCuenta());
                                objParamSalida = objDaoCierreDia.AbriDiaFacturacion(objCierreDias);
                                if (objParamSalida.getFlagIndicador() == 0) {
                                    objlstCierreDias.clear();
                                    seleccionaPeriodo();
                                }
