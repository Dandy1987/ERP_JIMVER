...
public class ControllerAnuAutoDocVen extends SelectorComposer<Component> implements InterfaceControllers {

    //Componentes Web
    @Wire
    Tab tab_listaAnuAutoDocVen, tab_mantenimientoAnuAutoDocVen;
    @Wire
    ...
    @Wire
    Combobox cb_canal, cb_tipoventa;
    @Wire
    ...
    @Wire
    Textbox txt_busq_supid, txt_busq_supdes, txt_busq_venid, txt_busq_vendes, txt_usuadd, txt_usumod,
            txt_lstcliid, txt_lstclides, txt_lstcondid, txt_lstconddes, txt_lstsupid, txt_lstsupdes, txt_lstvenid, txt_lstvendes,
    ...
    @Wire
    Listbox lst_anuautodocven, lst_docven;
    @Wire
    ...
    private static final Logger LOGGER = Logger.getLogger(ControllerAnuAutoDocVen.class);
    ...
    @Listen("onCreate=#tabbox_anuauto")
    ...
    public void busquedaRegistros() throws SQLException {
        ...
        int canal = (int) (cb_canal.getSelectedIndex() == -1 ? 0 : Integer.parseInt(cb_canal.getSelectedItem().getValue().toString()));

        objlstctacobcab = objDaoCtaCob.BusquedaFacturaBoletaCtaCob(canal, f_emisioni);

        //Validar la tabla sin registro
        if (objlstctacobcab.getSize() > 0) {
            lst_anuautodocven.setModel(objlstctacobcab);
        } else {
    ...
    @Listen("onSelect=#lst_anuautodocven")
    public void seleccionaRegistro() throws SQLException {
        objCtaCobCab = (CtaCobCab) lst_anuautodocven.getSelectedItem().getValue();
        if (objCtaCobCab == null) {
            objCtaCobCab = objlstctacobcab.get(i_selCab + 1);
        }
        i_selCab = lst_anuautodocven.getSelectedIndex();
        limpiarCampos();
    ...
    public void llenarCampos(CtaCobCab objCtaCobCab) throws SQLException {
        ...
        txt_lstcliid.setValue(objCtaCobCab.getCli_id());
        txt_lstclides.setValue(objCtaCobCab.getCli_des());
        txt_lstcondid.setValue(objCtaCobCab.getCon_id());
        txt_lstconddes.setValue(objCtaCobCab.getCon_des());
    ...
    public void limpiarBusqueda() {
        ...
        txt_lstcliid.setValue("");
        txt_lstclides.setValue("");
        txt_lstcondid.setValue("");
        txt_lstconddes.setValue("");
    }
