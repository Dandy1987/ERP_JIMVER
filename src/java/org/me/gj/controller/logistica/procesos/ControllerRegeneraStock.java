...
public class ControllerRegeneraStock extends SelectorComposer<Component> {
    ...
    DaoRegeneraStock objDaoRegeneraSotck;
    //Variables publicas
    //Variables de Sesion
    Session sesion = Sessions.getCurrent();
    UsuariosCredential objUsuCredential = (UsuariosCredential) sesion.getAttribute("usuariosCredential");
    private static final Logger LOGGER = Logger.getLogger(ControllerRegeneraStock.class);
    
    //Eventos Primarios - Transaccionales
    @Override
    public void doAfterCompose(Component comp) throws Exception {
        super.doAfterCompose(comp);
        objDaoRegeneraSotck = new DaoRegeneraStock();
    ...
    public void VerificarTransacciones() throws SQLException {
        ...
        objAccesos = objDaoAccesos.Verifica_Permisos_Transacciones(10209010, usuario, empresa, sucursal);
    ...
    public void regenerarStock() throws SQLException {
        if (cb_periodo.getSelectedIndex() == -1) {
            ...
            if (objCierrePer.getCieper_log() == 1) {
                Messagebox.show("¿Desea regenerar el stock para este periodo?", "ERP-JIMVER", Messagebox.OK | Messagebox.CANCEL,
                        Messagebox.QUESTION, new EventListener() {
                            ...
                            public void onEvent(Event event) throws Exception {
                                if (((Integer) event.getData()).intValue() == Messagebox.OK) {
                                    ...
                                    objParamSalida = objDaoRegeneraSotck.regenerarStock(objUsuCredential.getCodemp(), objUsuCredential.getCodsuc(), per_id, stk_usuadd);
