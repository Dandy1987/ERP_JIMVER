...
public class ControllerNotaESSubLin extends SelectorComposer<Component> {
    ...
    private static final Logger LOGGER = Logger.getLogger(ControllerNotaESSubLin.class);
    ...
    public void VerificarTransacciones() throws SQLException {
        ...
        objAccesos = objDaoAccesos.Verifica_Permisos_Transacciones(10303040, usuario, empresa, sucursal);
    ...
    public void busquedaRegistros() throws SQLException {
        ...
        if (resultado.equals("F1>")) {
            ...
            lst_notaesxsublin.setSelectedIndex(-1);
            ...
            objlstNotaESSublin = objDaoNotaES.listaTotalxSubLinea(f_emisioni, f_emisionf, per, slin_id);
    ...
    public void seleccionaRegistroTotal() throws SQLException {
        ...
        String periodo = objNotaESSublin.getPeriodo();
        String fecini = objNotaESSublin.getFecemi();
        String fecfinal = objNotaESSublin.getFecfin();
        String lin_key = String.valueOf(objNotaESSublin.getSlin_id());
        objlstNotaES = null;
        objlstNotaES = objDaoNotaES.ListaNotaESxSublinea(fecini, fecfinal, periodo, lin_key);
        LimpiarCampos();
        lst_notescab.setModel(objlstNotaES);
    }
    ...
    public void botonImprimir() throws SQLException {
        if (objlstNotaESSublin == null || objlstNotaESSublin.isEmpty()) {
            Messagebox.show("No hay notas de E/S por sublinea para imprimir", "ERP-JIMVER", Messagebox.OK, Messagebox.INFORMATION);
        } else {
            if (lst_notaesxsublin.getSelectedIndex() >= 0) {
                ...
                Messagebox.show("Seleccione una sublinea para imprimir sus notas E/S");
            }
        }
    }
    ...
    public void lovSubLineas() {
        if (bandera == false) {
            ...
            if (txt_slinid.getValue().isEmpty()) {
                ...
                Map objMapObjetos = new HashMap();
                String modoEjecucion = "NotaESSlin";
                ...
                objMapObjetos.put("controlador", "ControllerNotaESSubLin");
