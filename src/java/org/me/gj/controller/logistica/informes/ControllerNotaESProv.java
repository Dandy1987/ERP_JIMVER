...
public class ControllerNotaESProv extends SelectorComposer<Component> {
    ...
    private static final Logger LOGGER = Logger.getLogger(ControllerNotaESProv.class);
    ...
    public void VerificarTransacciones() throws SQLException {
        ...
        objAccesos = objDaoAccesos.Verifica_Permisos_Transacciones(10303010, usuario, empresa, sucursal);
    ...
    public void busquedaRegistros() throws SQLException {
        ...
        if (resultado.equals("F1>")) {
            ...
            lst_notaesxprov.setSelectedIndex(-1);
            ...
            objlstNotaESProv = objDaoNotaES.listaTotalxProveedor(f_emisioni, f_emisionf, per, prov_id);
    ...
    public void seleccionaRegistroTotal() throws SQLException {
        ...
        String per = objNotaESProv.getPeriodo();
        String fecini = objNotaESProv.getFecemi();
        String fecfinal = objNotaESProv.getFecfin();
        String prov_id = objNotaESProv.getProvid();
        objlstNotaES = null;
        objlstNotaES = objDaoNotaES.ListaNotaESxProveedor(fecini, fecfinal, per, prov_id);
        LimpiarCampos();
        lst_notescab.setModel(objlstNotaES);
    }
    ...
    public void botonImprimir() throws SQLException {
        if (objlstNotaESProv == null || objlstNotaESProv.isEmpty()) {
            Messagebox.show("No hay notas de E/S por proveedor para imprimir", "ERP-JIMVER", Messagebox.OK, Messagebox.INFORMATION);
        } else {
            if (lst_notaesxprov.getSelectedIndex() >= 0) {
                ...
                Window window = (Window) Executions.createComponents("/org/me/gj/view/impresion/logistica/informes/LovImpresionNotaESxProv.zul", null, objMapObjetos);
                window.doModal();
            } else {
                Messagebox.show("Seleccione un proveedor para imprimir sus notas E/S");
            }
        }
    }
    ...
    public void lovProveedores() {
        if (bandera == false) {
            ...
            if (txt_provid.getValue().isEmpty()) {
                String tipo = "1";
                Map objMapObjetos = new HashMap();
                String modoEjecucion = "NotaESProv";
                ...
                objMapObjetos.put("controlador", "ControllerNotaESProv");
