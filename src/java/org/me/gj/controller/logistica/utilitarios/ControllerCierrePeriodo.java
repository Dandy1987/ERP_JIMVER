...
public class ControllerCierrePeriodo extends SelectorComposer<Component> {
    ...
    public void VerificarTransacciones() throws SQLException {
        ...
        objAccesos = objDaoAccesos.Verifica_Permisos_Transacciones(10402000, usuario, empresa, sucursal);
                    ...
                    Messagebox.QUESTION, new EventListener() {
                        ...
                        public void onEvent(Event event) throws Exception {
                            if (((Integer) event.getData()).intValue() == Messagebox.OK) {
                                ...
                                objParamSalida = objDaoCierrePeriodo.CerrarPeriodoLogistica(objCierrePeriodos);
                    ...
                    Messagebox.QUESTION, new EventListener() {
                        ...
                        public void onEvent(Event event) throws Exception {
                            if (((Integer) event.getData()).intValue() == Messagebox.OK) {
                                ParametrosSalida objParamSalida;
                                objCierrePeriodos.setCieper_usumod(objUsuCredential.getCuenta());
                                objParamSalida = objDaoCierrePeriodo.AbriPeriodoLogistica(objCierrePeriodos);
                                if (objParamSalida.getFlagIndicador() == 0) {
                                    objlstCierrePeriodos.clear();
                                    seleccionaAnio();
                                }
