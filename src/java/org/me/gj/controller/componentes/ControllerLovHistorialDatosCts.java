 ...
 * @author achocano
 */
public class ControllerLovHistorialDatosCts extends SelectorComposer<Component> {

    @Wire
    Window w_lov_historial_cts;

    @Wire
    Listbox lst_historial_cts;
    ...
    public void doAfterCompose(Component window) throws Exception {
        ...
        objlstPersonal = objDaoPersonal.listaDatosPCts(Integer.parseInt(tipdoc), numdoc);
        lbl_personal.setValue(personal);
        lst_historial_cts.setModel(objlstPersonal);
    }
