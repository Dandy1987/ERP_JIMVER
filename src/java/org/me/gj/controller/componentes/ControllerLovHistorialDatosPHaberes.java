 ...
 * @author achocano
 */
public class ControllerLovHistorialDatosPHaberes extends SelectorComposer<Component> {
 @Wire
    Window w_lov_historial_ph;

    @Wire
    Listbox lst_historial_phaberes;
  ...
  @Override
    public void doAfterCompose(Component window) throws Exception {
        ...
        objlstPersonal = objDaoPersonal.listaDatosPHaberes(Integer.parseInt(tipdoc), numdoc);
        lbl_personal.setValue(personal);
        lst_historial_phaberes.setModel(objlstPersonal);
    }
