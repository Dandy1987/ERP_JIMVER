 ...
 * @author achocano
 */
public class ControllerLovDescuentosReintegros extends SelectorComposer<Component> {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        objlstDescuentos = objdaoDescuentos.listaDescuentosReintegros(0, periodo, "TODOS", null, null);
                                ...
                                if (objdaoDescuentos.validaPeriodoCalculando(txt_periodo.getValue().toString()) == 1) {
                                    ...
                                    if (i_valida == 1) {
                                        ...
                                        for (int i = 0; i < objLstDescuentosSelec.getSize(); i++) {
                                            objParam = objdaoDescuentos.insertarReintegro(i_sucu, objLstDescuentosSelec.get(i), txt_periodo.getValue(), d_fecha.getValue());
    ...
    public void cargarConsultar() throws SQLException {
        ...
        objlstDescuentos = objdaoDescuentos.listaDescuentosReintegros(sucu, txt_periodo.getValue(), tipoPersonal, dini, dfin);
        lst_lista.setModel(objlstDescuentos);
