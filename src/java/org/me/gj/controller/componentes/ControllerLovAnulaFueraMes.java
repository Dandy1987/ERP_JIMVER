...
public class ControllerLovAnulaFueraMes extends SelectorComposer<Component> {
    ...
    private static final Logger LOGGER = Logger.getLogger(ControllerLovAnulaFueraMes.class);
    ...
    public void habilitacampos(boolean valida1) {
        ...
        cb_serienctotal.setDisabled(valida1);
    }
