...
public class Canal {
    ...
    public Canal(int tab_id, String tab_subdes) {
        this.tab_id = tab_id;
        this.tab_subdes = tab_subdes;
    }

    public Canal(int tab_id, String tab_subdes, int tab_est, int tab_ord, String tab_nomrep, String tab_usuadd, String tab_usumod) {
        this.tab_id = tab_id;
        this.tab_subdes = tab_subdes;
