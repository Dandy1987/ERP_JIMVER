...
public class Categoria {
    ...
    public Categoria(int tab_cod, String tab_des, int tab_id, String tab_subdes, int tab_ord, String tab_nomrep, int tab_est) {
    ...
    public Categoria(int tab_id, String tab_subdes, int tab_ord, String tab_nomrep, int tab_est) {
        this.tab_id = tab_id;
        this.tab_subdes = tab_subdes;
        this.tab_ord = tab_ord;
        this.tab_nomrep = tab_nomrep;
