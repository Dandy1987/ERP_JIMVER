...
public class Moneda {
    ...
    private String tab_cod_sunat;

    public String getTab_cod_sunat() {
        return tab_cod_sunat;
    }

    public void setTab_cod_sunat(String tab_cod_sunat) {
        this.tab_cod_sunat = tab_cod_sunat;
    }

    public Moneda(int tab_id, String tab_subdes, int tab_ord, String tab_nomrep, int tab_est,String tab_cod_sunat) {
        this.tab_id = tab_id;
