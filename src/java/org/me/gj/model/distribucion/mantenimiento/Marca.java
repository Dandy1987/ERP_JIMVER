...
public class Marca {
    ...
    public Marca(int tab_cod, String tab_des, int tab_id, String tab_subdes, int tab_ord, String tab_nomrep, int tab_est, String tab_usuadd, String tab_usumod) {
    ...
    public Marca(int tab_id, String tab_subdes, int tab_ord, String tab_nomrep, int tab_est, String tab_usuadd, String tab_usumod) {
        this.tab_id = tab_id;
        this.tab_subdes = tab_subdes;
        this.tab_ord = tab_ord;
        this.tab_nomrep = tab_nomrep;
