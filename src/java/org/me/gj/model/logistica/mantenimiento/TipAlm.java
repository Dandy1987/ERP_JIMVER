...
public class TipAlm {
    ...
    public TipAlm(int tab_id, String tab_subdes, int tab_est, int tab_ord, String tab_usuadd, String tab_usumod) {
        this.tab_id = tab_id;
    ...
    public String getCod_id() {
        cod_id = Utilitarios.lpad(String.valueOf(tab_id), 3, "0");
        return cod_id;
    }
